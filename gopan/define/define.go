...
var RegisterCodeRedisPrefix = getenv("GOPAN_REGISTER_CODE_PREFIX", "register:code:")
var PasswordResetCodeRedisPrefix = getenv("GOPAN_PASSWORD_RESET_CODE_PREFIX", "password_reset:code:")
